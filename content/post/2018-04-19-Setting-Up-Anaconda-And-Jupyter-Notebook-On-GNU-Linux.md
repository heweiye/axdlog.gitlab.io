...
Conda provides [cheat sheet](https://docs.conda.io/projects/conda/en/latest/user-guide/cheatsheet.html) for a single-page summary of the most important information about using conda.
