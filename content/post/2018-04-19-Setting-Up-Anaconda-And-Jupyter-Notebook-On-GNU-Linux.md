...
### Release Version
The latest release version of [Anaconda][anaconda] is `5.3`.
...
Here use `Anaconda3-5.3.1-Linux-x86_64.sh` as an example, the page [Hashes for Anaconda3-5.3.1-Linux-x86_64.sh](https://docs.anaconda.com/anaconda/install/hashes/Anaconda3-5.3.1-Linux-x86_64.sh-hash/) lists the installation package information.
