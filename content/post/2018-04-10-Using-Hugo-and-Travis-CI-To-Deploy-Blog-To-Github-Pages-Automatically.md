...
My personal static blog is hosted on [Github][github]. I used [Hexo][hexo] before, but as its complicated package dependence and cumbersome deployment process, I have to encapsulated the whole deploying environment into Docker image for rapid deployment. But it was still too complex. Now I switch to [Hugo][hugo] which is faster, simpler.
...
[Install Hugo](https://gohugo.io/getting-started/installing/) is the official installation document of [Hugo][hugo]. If you're using GNU/Linux, you may consider using my [Python script](https://gitlab.com/MaxdSre/Python-learning-quiz/blob/master/LearningQuiz/Hugo-StaticSiteGeneratorInstallation.ipynb) to install it.
